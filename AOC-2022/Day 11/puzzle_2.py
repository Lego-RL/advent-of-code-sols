...
# need number to mod everything by that won't affect each monkeys divisible_by num
divisible_by_nums: list[int] = []
for monkey in monkey_objs:
    divisible_by_nums.append(monkey.divisible_by)

modulo_num: int = 1
for num in divisible_by_nums:
    modulo_num *= num
